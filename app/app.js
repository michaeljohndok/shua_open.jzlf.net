...
var APP_ID = 'zuba6uo8ezpulk0i7eteejqlv7udaasfvz1wc3w833g4ibei';
var APP_KEY = 'j6j9d73qzeh1lttd7shbs118xkco4cf7mthm1pn03cemdr6m';
AV.init({
  appId: APP_ID,
  appKey: APP_KEY
});
...
app.config(function($routeProvider) {
  ...
  $routeProvider.when('/wancheng', {
    templateUrl: './app/template/wancheng.html', 
    controller: 'WanchengController',
    reloadOnSearch: false
  });
  ...
  $routeProvider.when('/liushui', {
    templateUrl: './app/template/liushui.html', 
    controller: 'LiuShuiController',
    reloadOnSearch: false
  });

  $routeProvider.when('/pinduoduo', {
    templateUrl: './app/template/pinduoduo.html', 
    controller: 'PDDController',
    reloadOnSearch: false
  });
